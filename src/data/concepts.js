...
export const visualizations = [
  {
    ...
    description: 'Simple local rules produce complex global behaviour. Rule 110 achieves universal computation from three-cell neighbourhoods.',
  ...
  },
  {
    ...
    description: 'Trajectories in state space reveal the geometry of possible behaviours: fixed points, limit cycles, and strange attractors.',
  ...
  },
  {
    ...
    preview: 'Why there is no universal optimiser',
    description: 'The shape of the fitness function determines which search strategies can succeed. There is no universal optimiser.',
...
export const framingContent = [
  ...
  },
  {
    ...
    content: `Some systems are their own fastest simulators – there's no shortcut to predicting their behaviour. This isn't a limitation but a feature: it's what makes genuine novelty possible.`,
  },
  {
    id: 'learning-to-see',
...
export const theoreticalLayers = [
  {
    ...
    description: 'Everything begins with separation. Markov blankets create perspectives – statistical membranes where inside (μ) and outside (η) become conditionally independent given the boundary (b), yet remain connected through it.',
    equation: 'I(μ;η|b) = 0',
  },
  {
    id: 'uncertainty',
    ...
    description: 'Across boundaries flows information. Entropy H quantifies uncertainty; mutual information I(X;Y) captures what two processes reveal about each other – their shared secrets minus their independent mysteries.',
  ...
  },
  {
    ...
    description: 'Information closure (IC) measures how much better an internal model M predicts boundary inputs η than the boundary alone. The difference H(η|b) − H(η|Mμ) quantifies this predictive advantage. To persist is to predict.',
  ...
  },
  {
    ...
    description: 'Free energy F provides the mechanism: the negative log-probability of sensory states s plus the divergence D_KL between internal beliefs q and true posteriors p. Minimising F means reducing surprise and aligning beliefs with reality.',
  ...
  },
  {
    ...
    description: 'The ratio of information closure to metabolic cost (IC/C) is conserved across scales s. The derivative d/ds[IC/C] = 0 means no scale is privileged; from particles to galaxies, each maintains existence through identical efficiency.',
  ...
  },
  {
    ...
    description: 'Systems don\'t just persist moment-to-moment; they accumulate history. Functional information I_F measures how rare functional configurations are: −log₂ of the ratio of functional states N_func to total possible states N_total.',
